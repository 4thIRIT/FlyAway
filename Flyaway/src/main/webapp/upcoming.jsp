...
<div class="container-fluid">
<br><br>
<h3>All your upcoming trips are shown below </h3>
<br>
...
<table class="table">
	...
	<c:forEach var="passengers" items="${requestScope.passengers}">
		<tr>
			<td>${ passengers.getFlightdate()}</td>
			<td>${ passengers.getName()}</td>
			<td>${ passengers.getFlightid()}</td>
			<td>${ passengers.getAirline()}</td>
			<td>${ passengers.getDestination()}</td>
